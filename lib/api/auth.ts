...
export async function googleLogin() {
  ...
  if (error) {
    throw new Error(`Google login failed with status ${status}`);
  }
...
export async function googleCallback() {
  ...
  if (error || !data) {
    throw new Error(`Google callback failed with status ${status}`);
  }
...
export async function githubLogin() {
  ...
  if (error) {
    throw new Error(`GitHub login failed with status ${status}`);
  }
...
export async function githubCallback() {
  ...
  if (error || !data) {
    throw new Error(`GitHub callback failed with status ${status}`);
  }
